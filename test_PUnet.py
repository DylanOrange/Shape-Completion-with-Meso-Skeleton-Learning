...
parser.add_argument('--resume', default='checkpoint/punet_epoch_300.pth', type=str)
...
if __name__ == '__main__':
    ...
    test_dst = Dataset(npoint=2048,
            use_random=True, use_norm=True, split='test', is_training=False)
